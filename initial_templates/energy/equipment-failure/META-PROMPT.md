...
| **Schema** | `grid_ops` |
| **Workspace Folder** | `/Workspace/Users/{user}/ai_demos/equipment_failure_demo/` |

Derived paths:
- **Raw Data Volume**: `/Volumes/{catalog}/{schema}/raw_data/`
- **Quality Docs Volume**: `/Volumes/{catalog}/{schema}/raw_data/quality_docs/`
...
| 3 | Generate quality docs | `02-unstructured-docs.md` | PDFs in volume |
...
| 7 | Create Knowledge Assistant | `06-knowledge-assistant.md` | KA indexing quality docs |
...
```json
{
  "catalog": "pacific_grid",
  "schema": "grid_ops",
  "volume_path": "/Volumes/pacific_grid/grid_ops/raw_data",
  "workspace_folder": "/Workspace/Users/.../equipment_failure_demo",
  "pipeline_id": null,
  "dashboard_id": null,
  "genie_space_id": null,
...
| Pipeline | Tables populated, batch TRF-2024-Q3-887 shows failures |
| Genie | "Why so many outages?" returns meaningful analysis |
| Dashboard | Spike visible at a glance, filters work |
| KA | "Quality issues for transformer batch?" returns the report |
