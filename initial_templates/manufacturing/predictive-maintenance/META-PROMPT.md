...
| **Schema** | `operations` |
| **Workspace Folder** | `/Workspace/Users/{user}/ai_demos/maintenance_demo/` |

Derived paths:
- **Raw Data Volume**: `/Volumes/{catalog}/{schema}/raw_data/`
- **Maintenance Docs Volume**: `/Volumes/{catalog}/{schema}/raw_data/maintenance_docs/`
...
| 3 | Generate maintenance docs | `02-unstructured-docs.md` | PDFs in volume |
...
| 7 | Create Knowledge Assistant | `06-knowledge-assistant.md` | KA indexing maintenance docs |
...
```json
{
  "catalog": "precision_motors",
  "schema": "operations",
  "volume_path": "/Volumes/precision_motors/operations/raw_data",
  "workspace_folder": "/Workspace/Users/.../maintenance_demo",
  "pipeline_id": null,
  "dashboard_id": null,
  "genie_space_id": null,
...
| Pipeline | Tables populated, CNC-DTR-007 shows ~12% defect rate |
| Genie | "Why are defects high?" returns meaningful analysis |
| Dashboard | Spike visible at a glance, filters work |
| KA | "Maintenance alerts for CNC machine 7?" returns the report |
