...
SPACE_TITLE = "AI-BI - Customer Support: AI Efficiency"
SPACE_DESCRIPTION = (
    "Explore how an AI Support Copilot made customer support dramatically more "
    "efficient. Ask WHY resolution time and cost dropped in 2025 - Genie traces "
    "it to the Copilot GA release and rising daily usage."
)
