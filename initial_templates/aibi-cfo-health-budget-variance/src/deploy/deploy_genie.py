...
SPACE_TITLE = "AI-BI - Healthcare CFO Budget Variance"
SPACE_DESCRIPTION = (
    "Explore why a health system's year-end opex projection is ~$4.8M over budget on "
    "roughly flat revenue. Ask WHY Nursing is over budget - Genie traces it to contract "
    "labor: RN vacancies backfilled with agency nurses at ~2x cost, mostly through one "
    "vendor (Apex Clinical Staffing), concentrated at two hospitals."
)
