...
SPACE_TITLE = "AI-BI - Sales Pipeline Review"
SPACE_DESCRIPTION = (
    "Track a beauty brand's sales against its quarterly target across regions and "
    "product lines, with data unified from Salesforce (accounts/pipeline), the ERP "
    "(actual orders/revenue), Finance (targets) and the product catalog (launches). "
    "Ask whether we'll hit the quarter and what's driving the recent spike - Genie "
    "traces it to the new Fragrance line that launched in EMEA on 2026-05-04."
)
