...
Workflow:
  ...
  3. Upload each PDF to UC Volume:
       /Volumes/retail_consumer_goods/luxebeauty_demo/manufacturing_reports/<name>.pdf
  4. The volume is created if missing.

Dependencies: `plutoprint` + the `databricks-sdk` (already in the the demo library venv).
