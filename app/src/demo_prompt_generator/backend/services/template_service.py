...
def _should_include_in_template(relative_path: str) -> bool:
    """Templates carry only the narrative markdown (README, architecture, specs).
    Code, bundle config, notebooks, and resource JSON are project-specific and
    should be regenerated by the agent in each fork, not inherited."""
