...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      // App-wide: modals just fade in/out (a subtle zoom, no slide/translate).
      // The slide-from-corner used to fight the -50%/-50% centering transform
      // and read as the dialog flying in from the top-left.
      className={cn(
