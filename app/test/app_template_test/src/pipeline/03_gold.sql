...
JOIN read_files('/Volumes/retail_consumer_goods/luxebeauty_demo/raw_data/customers', format => 'parquet') c
...
WITH order_agg AS (
  ...
  FROM read_files('/Volumes/retail_consumer_goods/luxebeauty_demo/raw_data/orders', format => 'parquet')
