...
slug: genie-space
category: capability
tags: [genie, natural-language, sql, exploration, ai-bi]
description: >
  Context for generating Genie space specifications, including table selection, system
  instructions with domain knowledge, sample question design, and expected response patterns
  that make the Genie feel like a domain expert rather than a generic SQL assistant.
related: [aibi-dashboards, multi-agent-supervisor, declarative-pipeline]
---
