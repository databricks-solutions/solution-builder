...
category: capability
tags: [agents, orchestration, routing, supervisor, multi-agent]
description: >
  Context for generating multi-agent supervisor specifications, including agent role definition,
  routing logic between Genie and Knowledge Assistant (or other agents), and demo flow design
  that showcases intelligent query routing.
related: [genie-space, knowledge-assistant, model-serving]
---
