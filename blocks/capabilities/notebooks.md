...
slug: notebooks
category: capability
tags: [notebook, analysis, ml, exploration, training]
description: >
  Context for generating notebook specifications for interactive analysis, ML model training,
  ad-hoc exploration, and data validation. Covers notebook structure, narrative flow, and
  how notebooks complement the automated pipeline in a demo.
related: [model-serving, declarative-pipeline, synthetic-data-gen]
---
