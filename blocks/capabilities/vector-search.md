...
slug: vector-search
category: capability
tags: [vector-search, embeddings, rag, similarity, retrieval]
description: >
  Context for generating Vector Search specifications, including endpoint and index
  configuration, embedding model selection, chunking strategy for documents, and how
  vector search powers the Knowledge Assistant's retrieval layer.
related: [knowledge-assistant, multi-agent-supervisor, model-serving]
---
