...
### Final review:
Make sure you created all the Databricks resources according to the story and the spec files, and that they're all in the resources.json file, and that we don't have mention to luxebeauty reference anymore.